(function(){
  ...
  style.textContent=`
    ...
    body.screener-page #content>.card:first-child{padding:16px}
    body.screener-page #content>.card:first-child .note{font-size:8.5px;line-height:1.3;margin-bottom:6px}
    body.screener-page #content>.card:first-child .statline{gap:4px;margin-top:5px}
    body.screener-page #content>.card:first-child .statpill{font-size:7px;padding:3px 5px}
    body.screener-page #content>.card:first-child .table-wrap{overflow-x:hidden}
    body.screener-page #content>.card:first-child table.data-table.screener-compact{table-layout:fixed;width:100%;min-width:0!important}
    body.screener-page #content>.card:first-child table.data-table.screener-compact th{padding:4px 2px;font-size:7.2px;line-height:1;white-space:normal!important;overflow-wrap:anywhere;vertical-align:bottom}
    body.screener-page #content>.card:first-child table.data-table.screener-compact td{padding:4px 2px;font-size:8px;line-height:1.04;vertical-align:top;white-space:normal;overflow-wrap:anywhere}
    body.screener-page #content>.card:first-child table.data-table.screener-compact td b{font-size:8.6px}
    body.screener-page #content>.card:first-child table.data-table.screener-compact .mini{font-size:5.9px;line-height:1.02;white-space:normal;opacity:.7;letter-spacing:-.025em;margin-top:1px}
    body.screener-page #content>.card:first-child table.data-table.screener-compact .reading{min-width:0!important;width:auto!important;max-width:none!important;font-size:7.2px;line-height:1.04}
    body.screener-page #content>.card:first-child table.data-table.screener-compact .signal-note{font-size:6.8px;line-height:1.04}
    ...
    @media(min-width:1440px){
      ...
      body.screener-page #content{max-width:none!important;width:calc(100vw - 285px)!important;margin-left:250px!important;margin-right:20px!important;padding-left:0!important;padding-right:0!important}
      body.screener-page .page-header{max-width:none!important;width:calc(100vw - 285px)!important;margin-left:250px!important;margin-right:20px!important}
    }
    ...
    @media(max-width:640px){.section-mobile{padding:7px 12px}.section-mobile-label{display:none}}
